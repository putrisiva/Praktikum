...
if karakter == 1 :
    kalimat_2 = ("Primel sedang olahraga ")
if karakter == 2 :
    kalimat_2 = ("Primel sedang bermain ")
if karakter == 3 :
    kalimat_2 = ("Primel sedang bersantai ")
...
if tempat == 1 :
    kalimat_5 = ("ia mengerjakanya di lapangan, ")
if tempat == 2 :
...
if pekerjaan == 2 :
    kalimat_8 = ("karenanya ia hanya membuka kios didepan rumah ")
if pekerjaan == 3 :
